    ...
    <>
      <div className="container">
        <div className="flex mt-3 font-main ">
          {/* <div className="md:hidden lg:flex lg:justify-start  ">
            <h1 className="hidden md:hidden mt-4 mx-12 font-bold md:w-[600px] md:ml-[0px] text-[28px]">
              Places To Explore Around Puducherry
            </h1>
            <div>
              <div className="grid md:grid-rows-2">
                <h1 className="hidden md:block lg:hidden mt-4 mx-12 font-bold md:w-[600px] md:ml-[0px] text-[28px]">
                  Places To Explore

                </h1>
              </div>
              <div>
                <p>Around Puducherry</p>
          ...
          <div className="pt-2 md:w-[100px] md:ml-[-112px] lg:ml-[550px] flex justify-end  mt-4 ">
            <button
              type="button"
