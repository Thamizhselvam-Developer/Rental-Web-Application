...
<div className=' w-full flex justify-between items-start animate-pulse'>
 ...
 <div className="container grid gap-4 justify-center items-center grid-cols-1  md:grid-cols-2 lg:grid-cols-3  font-main mt-[-13px]  ">
          {cardData.map((items, id) => (
            <div key={id} className=" m-9 rounded-2xl shadow-[0px_4px_11px_8px_rgba(0,_0,_0,_0.1)]">
