      ...
      <div className="container">
        <div className="flex mt-3 font-main md:justify-between  lg:justify-between  ">
          <div className="hidden   md:flex md:ml-[20px] lg:flex lg:justify-start  ">
            <h1 className="md: hidden lg:block mt-[-40px] md:mt-4 lg:mt-4 font-bold md:w-[600px] text-[28px] tracking-wider">
          ...
          <div className="pt-2 md:w-[100px] md:ml-[85px]  flex justify-end  mt-4 ">
            <button
              type="button"
              className=" hidden md:hidden lg:block rounded-full border-2 border-gray-700  w-24 h-9 hover:bg-[#FF0000]"
            >
              View All
            </button>
