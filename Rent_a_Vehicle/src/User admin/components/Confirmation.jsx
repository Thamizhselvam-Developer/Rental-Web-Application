...
<div className='flex gap-2'>
 ...
 <div className='border-2  w-[850px] h-[285px] rounded-lg'>
    <h1 className='font-bold text-[23px] text-white text-center rounded-md bg-slate-500'>Your receipt</h1>
    <hr />
  <div className='px-2'>
    <h1 className=''> Extra Add-ons:</h1>
        <div className="flex items-center rounded-sm dark:border-gray-700  ">
                  ...
                  <div className="flex items-center rounded-sm dark:border-gray-700 ">
                    ...
                    <input className='border mx-2 px-1 text-md font-light rounded-md ' 
                    type="text"
...
<ul>
    ...
    <div className='flex  justify-between'>
     ...
     <div className='flex  justify-between'>
        <li className='font-extrabold text-[20px]'>Total:</li>
...
<div className='flex justify-center gap-6 mt-6'>
    <button className='border rounded-lg py-1.5 px-3 bg-green-600 hover:bg-green-700 text-white '>Booking Confirm</button>
    <button className='border rounded-lg py-1.5 px-3 bg-primary hover:bg-red-600 text-white'> Booking Cancel</button>
</div>
