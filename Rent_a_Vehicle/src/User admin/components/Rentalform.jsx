...
const Rentalform = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.msg === 'Form Submitted Succesfully') {
        setSubmitForm(true)
        // Navigate('/');
      }
    } catch (error) {
  ...
  return (
    <>

      {
        ...
        submitForm ? (
          <>
            <div className=" items-center rounded-md  h-screen  bg-main overflow-hidden px-4">

              <div className=''>
                <div className="bg-white items-center h-screen shadow-xl rounded-2xl p-10  text-center ">
                  <svg
                    className="mx-auto h-20 w-20 text-primary mb-4 animate-bounce border-primary border-2   rounded-lg"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    viewBox="0 0 24 24"
                  ...
                  <h2 className="text-6xl font-main text-gray-800 mb-3">Submission Successful!</h2>
                  <p className="text-gray-600 mb-4 text-sm">
                    Thank you for becoming a partner! We’ve received your details.
                  </p>
                  <p className='text-gray-600 mb-4 text-sm'> Our team will verify your info and contact you by email shortly.</p>
                  <div className='grid  justify-center'>
                    <div className='w-[700px]  h-[130px] grid  grid-cols-[200px_1fr]   border-l-[10px] rounded-3xl border-green-400 bg-green-100'>
                      <div className='w-[70px] mx-5 my-auto '>
                        <img src={Tick} className='flex item-center' />
                      </div>
                      <div className='grid grid-rows-2 justify-start items-center font-Caveat'>
                        <div className=''>
                          <span>Application Submitted</span>
                        </div>
                        <div>
                          <span>
                            Your Patnership request has been received
                          </span>
                        </div>
                  ...
                  <div className='grid justify-center'>
                    <button className='bg-primary w-[120px] rounded-md h-10'>Return Home</button>
                  </div>
          ...
          <div className="w-full h-full  mt-[100px] ">
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="grid md:grid-cols-1 md:justify-center lg:justify-center lg:grid-row-2 lg:mx-10  gap-0">
                <div className=" w- bg-slate-50 p-6 border-r">
