          ...
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2 p-5">
              <div className="max-w-sm mx-auto">
                ...
                <form className="space-y-3 grid justify-center" onSubmit={handleSubmit}>
                  ...
                  <div className="relative ">
                    ...
                    <div className="relative">
                      ...
                      />  
                          ...
                          <div className="absolute inset-y-0 left-[270px] md:left-[320px] lg:right-10  flex items-center pointer-events-none">
                               <p className="   " onClick={handleEyeButton}>
            ...
            <div className="hidden lg:block lg:w-[50%] bg">
              <div className=" relative h-full flex items-center justify-center p-4">
                 <div>
                  <Link to="/login" >
                  <button className=" absolute right-[-10px] top-0 w-8 h-8  items-center ">
