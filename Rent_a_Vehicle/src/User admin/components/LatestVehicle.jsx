...
<div className=' w-full flex justify-between items-start animate-pulse'>
  ...
  <span className="h-2 bg-gray-300 rounded-full w-16 "></span>
      ...
      <div className=""> 
        <div className=" flex justify-around md:justify-between md:items-center mb-9 md:mt-[20px]">
        ...
        <div className="grid  justify-center items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 font-main mt-[-13px]">
          {LatestVehicledata.slice(0,3).map((items, id) => (
            ...
            <div className="flex justify-center  md:justify-center   lg:justify-between xl:justify-between  mt-5 mx-4 mb-5 shadow-red-900">
            ...
            <div className="pt-2 md:w-[100px] md:ml-[85px] lg:ml-[750px] flex justify-center mt-4 ">
          
            <Link to="/CompleteLatestCard">  
            
            <button
              type="button"
              className=" md:hidden rounded-full border-2 border-gray-700 w-24 h-9 hover:bg-[#FF0000]"
            >
              View All
            </button>
              </Link>
